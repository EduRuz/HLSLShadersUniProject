...
{
	initShader(L"Simple_vs.cso", L"4LightPS.cso");//With new shaders instead
}
...
void SimpleShader::initShader(WCHAR *vsFilename, WCHAR *psFilename)
{
...
void SimpleShader::setShaderParameters(ID3D11DeviceContext * deviceContext, const XMMATRIX & worldMatrix, const XMMATRIX & viewMatrix, const XMMATRIX & projectionMatrix, ID3D11ShaderResourceView * texture, Light * light, Camera * cam)
{
...
void SimpleShader::setShaderParameters(ID3D11DeviceContext * deviceContext, const XMMATRIX & worldMatrix, const XMMATRIX & viewMatrix, const XMMATRIX & projectionMatrix, ID3D11ShaderResourceView * texture,  Camera * cam,  Light * pointLight1, Light * pointLight2, Light * pointLight3, Light * pointLight4, AttenuationValues AV)
{
